...
class CurrencyService {
  ...
  Future<List<CurrencyInfo>> getTrendingList() async {
    ...
    list.add(await getCurrencyInfo('CNY'));
    list.add(await getCurrencyInfo('HKD'));
    list.add(await getCurrencyInfo('THB'));
    list.add(await getCurrencyInfo('VND'));
    list.add(await getCurrencyInfo('NZD'));
    list.add(await getCurrencyInfo('KHR'));
    list.add(await getCurrencyInfo('KRW'));
    list.add(await getCurrencyInfo('SAR'));
    list.add(await getCurrencyInfo('SGD'));
