...
class _ConverterWidgetState extends State<ConverterWidget> {
  final TextEditingController _textEditingController = TextEditingController(text: '0.00');
  double _amount = 1;
  String _fromCurrency = 'USD';
  String _toCurrency = 'HKD';
    ...
    return Container(
      child: Column(
        children: [
          ...
          SizedBox(height: 30),
          // Chart
          ChartWidget(fromCurrency: _fromCurrency,toCurrency: _toCurrency, chartData: chartData),
          SizedBox(height: 30),
          // Trending list
                        ...
                        child: Container(
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                '$_toCurrency ${rate!.totalFromCurrencyRate} ',
                              ...
                              Text(
                                '$_fromCurrency ${rate.totalToCurrencyRate}',
                                style: TextStyle(
                                  fontSize: 22,
                                  fontWeight: FontWeight.bold,
                                  color: Colors.black,
